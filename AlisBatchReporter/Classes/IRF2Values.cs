...
namespace AlisBatchReporter.Classes
{
    class Irf2Values
    {
        ...
        public static readonly Irf2Values PlanCode = new Irf2Values(10, false, "Plan Code");
        public static readonly Irf2Values PlanName = new Irf2Values(11, false, "Plan Name");
        ...
        public static readonly Irf2Values LastName = new Irf2Values(14, false, "Last Name");
        public static readonly Irf2Values FirstName = new Irf2Values(15, false, "First Name");
        public static readonly Irf2Values MiddleName = new Irf2Values(16, false, "Middle Name");
        ...
        public Irf2Values(int idxValue, bool intable, string name)
        {
            IdxValue = idxValue;
            Intable = intable;
            Name = name;
        ...
        public static IEnumerable<Irf2Values> Values
        {
            get
            {
